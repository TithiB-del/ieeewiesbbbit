          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Dedicated individuals working together to promote diversity and inclusion in engineering.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                },
                {
                  name: "Emily Chen",
                  role: "Vice Chair",
                  bio: "Electrical Engineering junior focused on renewable energy systems.",
                  image: "/placeholder.svg?height=400&width=400",
                },
                {
                  name: "Priya Patel",
                  role: "Secretary",
                  bio: "Mechanical Engineering sophomore with interests in robotics.",
                  image: "/placeholder.svg?height=400&width=400",
                },
                {
                  name: "Maria Rodriguez",
                  role: "Treasurer",
                  bio: "Civil Engineering senior specializing in sustainable infrastructure.",
                  image: "/placeholder.svg?height=400&width=400",
                },
                {
                  name: "Zoe Williams",
                  role: "Events Coordinator",
                  bio: "Biomedical Engineering junior passionate about healthcare technology.",
                  image: "/placeholder.svg?height=400&width=400",
                },
                {
                  name: "Aisha Khan",
                  role: "Outreach Coordinator",
                  bio: "Computer Engineering senior with experience in embedded systems.",
                  image: "/placeholder.svg?height=400&width=400",
                },
              ].map((member, index) => (
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">wie@university.edu</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Every Tuesday at 5:00 PM in Engineering Building, Room 302
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
